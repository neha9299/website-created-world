...
let pvr = [
    {
        ...
        date: 27,
        img: 'img/chhava-movie-posters-all-the-poster-quality-looks-amazing-v0-60akt0vg93ee1.webp',
        video: 'video/Chhaava  Official Trailer  Vicky K  Rashmika M  Akshaye K  Dinesh Vijan  Laxman U  14th Feb - Maddock Films (1080p, h264) (2).mp4',
        background: 'img/chhaava-et00408691-1737623374.avif',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'sanamterikasam',
        loc: 'Dwarka Sector 14 , New Delhi',
        audi: 2,
        type: '4DX',
        series: ['J', 'H', 'F', 'E', 'D', 'C', 'B', 'A'],
        ...
        c: [6, 8, 11, 12, 19],
        b: [8, 5, 12, 13, 14],
        a: [5, 8, 10, 18, 20, 27, 26, 11, 15, 1],
        price: [800, 800, 560, 560, 560, 560, 430, 430],
        date: 27,
        img: 'img/sanam-teri-kasam-et00036895-1730964847.avif',
        video: 'video/Sanam Teri Kasam - Re Releasing Trailer  7th Feb 2025  Harshvardhan, Mawra, Radhika, Vinay, Deepak - Soham Rockstar Entertainment (1080p, h264).mp4',
        background: 'img/8ddda61b362c6d7cdb8b55b8af3aeed1f6a31129ecf2157f37288a5495800f08.jpg',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'badassravikumar',
        loc: 'Dwarka Sector 14 , New Delhi',
        audi: 2,
        type: '4DX',
        series: ['J', 'H', 'F', 'E', 'D', 'C', 'B', 'A'],
        ...
        price: [800, 800, 560, 560, 560, 560, 430, 430],
        date: 27,
        img: 'img/badass-ravikumar-et00343879-1736145960.avif',
        video: '',
        background: 'img/mainbadassravikumar-1738939496.jpg',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'Chhaava',
        ...
        document.getElementById('ticket').style.display = 'block';
          ...
          tic.innerHTML= `
                    ...
                    <div class="tic_details" style=" background: url(${data[0].background})no-repeat center -35px /cover">
                        ...
                        <h5 class="pvr"><span>N</span> BK</h5>
                        <h1>${url_segment[1]}</h1>
                        <div class="seat_det">
                            <div class="seat_cr">
                                <h6>ROW</h6>
          ...
          `
           ...
           JsBarcode(`#${seat_sr}${seat_no}barcode`,
            `${seat_sr.toLocaleUpperCase()}${seat_no}${seat_price}${main_date}22025`);
        })
 })
